#this file goes through each account and sees if they follow each other
...
# PAIRS_FILE = 'allAccounts-pairs-followEachOther.csv'
...
f = open('allAccounts-pairs-followEachOther.csv')
lines = f.readlines()
f.close()
